  ...
  <BContainer fluid>
    ...
    <template v-if="layoutType === 'vertical' || layoutType === 'semibox'">
      <ul class="navbar-nav h-100" id="navbar-nav">
        ...
        <li class="nav-item">
          <router-link to="/admin" class="nav-link" data-key="t-Dashboard">
        ...
        <li class="nav-item">
          <router-link to="/AllQuestions" class="nav-link" data-key="t-AllQuestions">
            <i class="ri-question-line"></i>
            {{ $t("Gestion des questions") }}

          </router-link>
        </li>
        <li class="nav-item">
          <router-link to="/allEtudiants" class="nav-link" data-key="t-allEtudiants">
            <i class="ri-user-2-fill"></i>
            {{ $t("Gestion des étudiants") }}

          </router-link>
        </li>
        <li class="nav-item">
          <router-link to="/allTests" class="nav-link" data-key="t-allTests">
